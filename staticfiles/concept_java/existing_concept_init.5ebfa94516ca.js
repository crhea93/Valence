function existing_concept_init(title,x,y,width,height,shape,text_scale,num,note_hidden,note_value,modifiable) {
    num = parseInt(num);
    var class_shape = '';
    var slide_val = 0;
        ...
        '<div id="block_form_' + num + '" class="card-body block-form concept_form" hidden>' +
            '<div class="form-row">' +
                '<div class="form-group">' +
                    '<input class="col-md-10" type="text" placeholder="text" id="title_' + num + '" value="'+title+'" font-size: '+text_scale+'pxmaxlength = "50" >'+
                '</div>'+
            '</div>' +
